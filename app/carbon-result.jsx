...
export default function CarbonResult() {
  ...
  if (!userData) {
    return (
      <View
        style={[styles.container, { backgroundColor: '#001F3F', justifyContent: 'center' }]}
      >
  ...
  const clearHistory = async () => {
    ...
    try {
      ...
      console.log('🗑️ Cleared all footprint records');
    } finally {
      setClearing(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      <Animated.View style={[styles.toast, fadeStyle]}>
        <Text style={styles.toastText}>🎉 Footprint saved & calculated!</Text>
      </Animated.View>
